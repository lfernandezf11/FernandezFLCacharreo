                ...
                <div class="col-12 col-lg-10">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            <div class="scroll-historial-container px-2" style="max-height: 55vh; overflow-y: auto;">
                            ...
                            <div class="col-12 mt-4 d-flex align-items-center justify-content-center">
                                <form method="post" action="${context}/FrontController">
                                    <button type="submit" class="btn btn-primary me-2" name="accion" value="perfil">Volver al perfil</button>
                                    <button type="submit" class="btn btn-secondary" name="accion" value="inicio">Seguir comprando</button>
                                </form>
                            </c:otherwise>
                        </c:choose>
                    </div>
